...
If there are not enough unassociated clients, the aircrack suite can be used to deauthenticate clients off nearby networks (more details here: http://www.aircrack-ng.org/doku.php?id=deauthentication)
